---
title: "AI Job Search Prerequisites and System Requirements"
...
<Note>
  See the [Claude Code documentation](https://docs.anthropic.com/en/docs/claude-code) for full setup details, including API key configuration and subscription options.
</Note>
