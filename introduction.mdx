...
description: "AI Job Search is an open-source framework built on Claude Code. Fork it, fill in your profile, and let Claude evaluate jobs, tailor CVs, write cover letters, and prepare for interviews."
---
