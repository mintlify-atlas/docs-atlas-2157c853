---
title: "Manually Editing Your Candidate Profile Files"
sidebarTitle: "Profile Files"
description: "Every profile file the /apply workflow reads, what each one contains, and how to edit them directly without re-running /setup."
---
...
This re-runs only the search configuration interview — which roles to target, which skills to search for, which locations, and which portals — and updates `search-queries.md` accordingly. Other profile sections are left untouched.
</Tip>
